        ...
        <Aux>
            <div id={props.unique} class="modal modal-fixed-footer">
                <div class="modal-content">                                        
                    <h4 class="card-title grey-text text-darken-4">{props.project.Name}<i class="modal-close material-icons right">close</i></h4>
                    ...
                    <div className="row">
                        <div className="col m6">
                            <h5 align="center" class="grey-text text-darken-3">Mentors</h5>
                            <ul align="center" className="mentor-list">
                                {props.project.mentors.split(",").map((mentor) => <li class="card-title grey-text text-darken-3">{mentor}</li>)}
                            </ul>
                        </div>
                        <div className="col m6">
                            <h5 align="center" class="grey-text text-darken-3">Interns</h5>
                            <ul align="center" className="intern-list">
            ...
            <div class="col m4">
                <div class="card modal-trigger" href={'#'+props.unique}>
