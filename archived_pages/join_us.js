...
function JoinUs() {
    const data = [
        ...
        },
        {
            ...
            step_name: 'Register',
            step_desc:
                'Once you see a post, register for the recruitment process',
        },
        {
            step: '3',
        ...
        },
        {
            ...
            step_desc:
                'Show us how much engineering and problem-solving excites you',
        },
        {
            step: '5',
            step_name: 'Formalities',
            step_desc:
                'Wait for further announcements and complete any formalities',
        },
        {
            step: '6',
