        ...
        <div className="rounded-xl group relative cursor-pointer items-center justify-center overflow-hidden transition-shadow hover:shadow-xl hover:shadow-black/30 border-2 border-gray-800">
            ...
            <div className="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-black group-hover:from-black/70 group-hover:via-black/60 group-hover:to-black/70"></div>
                ...
                <div className='flex items-center justify-center'>
                    <a className="mr-6  text-neutral-600 dark:text-neutral-200" href={gmail}>
                    <svg
                    ...
                    <a className="mr-6 text-neutral-600 dark:text-neutral-200 " href={linkedin}>
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        className="h-4 w-4"
                        fill="currentColor"
                    ...
                    <a className="text-neutral-600 dark:text-neutral-200" href={github}>
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        className="h-4 w-4"
                        fill="currentColor"
