...
export default function Cards(props) {
  ...
  return (
		...
		>
			<img
				className="lg:h-[400px] h-auto w-full phone:w-auto phone:h-[350px] aspect-auto cursor-pointer transition-transform duration-500  group-hover:scale-125"
				src={pfp}
				alt=""
			/>
			...
			<div className="absolute inset-0 flex translate-y-[40%] flex-col items-center justify-center px-2 text-center transition-all duration-500 group-hover:translate-y-[30%]">
				<h1 className="mb-7 lg:text-3xl text-xl font-bold text-gray-300 font-martian-mono">
					{name.toUpperCase()}
				</h1>
