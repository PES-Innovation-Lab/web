  ...
  return (
    <>
      <div className="p-8 bg-black">
        <h2 className="text-step-6 text-center">PROFESSORS</h2>
      </div>

      <div className="flex flex-col md:flex-row">
        {/* LEFT STICKY CONTAINER */}
        <div className="bg-black h-screen flex-1 sticky top-16 md:block hidden">
          <div className="grid place-items-center h-full">
            <div className="relative h-3/4 w-full md:h-1/3 md:w-1/3">
              <Image
                src={
                  profData[
                    profData.findIndex((p) => p.name === professorInView)
                  ].image
                }
                layout="fill"
                objectFit="contain"
