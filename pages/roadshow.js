...
function RoadShow(){
    ...
    useEffect(() => {
        const fetchData = async() =>{
            const result = await fetch("https://pil-api.herokuapp.com/events/roadshow");
        ...
        <div className='hashCodeHeadSection'>
            <Container>
                ...
                <Typography className={styles.subtitle_style} style={{marginTop: 40}}>
                    RoadShow is a project exhibition where summer interns showcase their projects to their peers and faculty.
                </Typography>
            </Container>
        </div>        
