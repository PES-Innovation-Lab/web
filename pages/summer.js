...
import internshipData from '../public/data/events/internship.json';
...
function Incito() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      //   'https://api-vercel-mlabwebdev.vercel.app/events/internship'
      // );
  ...
  return (
    <Layout title={'PIL | Summer Internship'} active={'Summer'}>
      <div className="hashCodeHeadSection">
        <Container>
          <Typography className="pageHeader">Summer Internship</Typography>
          ...
          <Typography
            ...
            style={{ marginTop: 40 }}
          >
            1st year and 2nd year students work on exciting projects over their
            summer vacations.
          </Typography>
        </Container>
      </div>
