      ...
      text: (
        <div className="eventSection">
          <div className="eventSectionText">
            ...
            <Typography className="eventText">
              Every year, we look for enthusiastic and passion-driven people to
              become a part of our community. To find those among you who are a
              good fit, we conduct an aptitude challenge and give you an
              opportunity to show us how passionate you are about engineering
              and building solutions to real-world problems.
            </Typography>
          </div>
        </div>
      ),
  ...
  return (
    <Layout title={'PIL | Events'} active={'Events'}>
      <Container>
        ...
        <Typography
          style={{ textAlign: 'center', color: 'white', fontSize: '1.8rem' }}
        >
        ...
        >
          We have the perfect platform and events for your skills and ideas to
          explore new heights
        </Typography>
