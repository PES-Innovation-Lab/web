        ...
        <div className='hashCodeHeadSection'>
            <Container>
                ...
                <Typography className={styles.subtitle_style} style={{marginTop: 40}}>
                    Incito is a highly competitive ideathon where participants come up with ideas of their own that solve important social problems, environmental and industrial problems out there in the world.
                </Typography>
            </Container>
        </div>        
